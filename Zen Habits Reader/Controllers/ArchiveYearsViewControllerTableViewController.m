...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
    ...
    if([segue.identifier isEqualToString:ToArchivePostsSegue])
        {
        ArchivePostsTableViewController *postsViewController = segue.destinationViewController;
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription
                                   entityForName:@"Year" inManagedObjectContext:context];
    
    [fetchRequest setEntity:entity];
    
    NSSortDescriptor *sort = [[NSSortDescriptor alloc]
                              initWithKey:@"theYear" ascending:NO];
...
- (void)configureCell:(ZenTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
    {
