...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:ZenTableViewCellIdentifier bundle:nil] forCellReuseIdentifier:ZenTableViewCellIdentifier];
    self.tableView.tableFooterView = [UIView new];
    [self prepareTableHeaderWithText:@"A curated list of the best posts to help you reach your Zen potential"];
...
- (UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
    {
        ...
        cell.titleLabel.text = [NSString stringWithFormat:@"%ld", [BestPostsLists mostRecentPostYear] - indexPath.row];
        return cell;
    }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if([segue.identifier isEqualToString:ToBestPostsSegue])
        {
        BestPostsViewController *bestPostsViewController = segue.destinationViewController;
