...
- (void)viewDidLoad {
    ...
    if (self.fetchedResultsController.fetchedObjects.count < 1)
        ...
        [[NSBundle mainBundle] loadNibNamed:@"ProblemViewController" owner:pvc options:nil];
...
- (NSFetchedResultsController*) createFetchedResultsController
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"(isRead = NO) AND (date > %@)", checkDate];
