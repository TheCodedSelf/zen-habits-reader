...
- (NSFetchedResultsController*) createFetchedResultsController
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"(month.year.theYear = %@)", self.currentYearString];
    [fetchRequest setPredicate:predicate];
    
    NSFetchedResultsController *theFetchedResultsController =
    [[NSFetchedResultsController alloc] initWithFetchRequest:fetchRequest
                                        managedObjectContext:context sectionNameKeyPath:@"month"
                                                   cacheName:nil];
...
- (NSInteger)sectionsCountForTableView
    {
    _currentYear = [[PersistenceManager sharedInstance] getYear:self.currentYearString];
