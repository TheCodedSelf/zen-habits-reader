...
+ (KGNLoadingView *)createLoadingViewInView:(UIView *)view {
  ...
  kgnLoadingView =
      [[KGNLoadingView alloc] initWithFrame:CGRectMake(75, 155, 170, 170)];
  kgnLoadingView.autoresizingMask = (UIViewAutoresizingFlexibleLeftMargin |
                                     UIViewAutoresizingFlexibleRightMargin |
                                     UIViewAutoresizingFlexibleTopMargin |
                                     UIViewAutoresizingFlexibleBottomMargin);
  kgnLoadingView.backgroundColor =
      [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
  kgnLoadingView.clipsToBounds = YES;
  kgnLoadingView.layer.cornerRadius = 10.0;

  kgnLoadingView.center =
      [view convertPoint:view.center fromView:view.superview];
  activityView = [[UIActivityIndicatorView alloc]
      initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
  activityView.frame = CGRectMake(65, 40, activityView.bounds.size.width,
